...
urlpatterns = [
    ...
    url(r'products/official', views.ProductOfficial.as_view(), name='product-official'),
    url(r'products/recommended', views.ProductRecommended.as_view(), name='product-recommended'),
    ...
    url('^products/byCategory/(?P<categoryId>.+)/$', views.ProductByCategory.as_view(), name='product-by-category'),
