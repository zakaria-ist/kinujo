...
class Product(models.Model):
    ...
    pr = models.TextField(default='')
    url_str = models.CharField(max_length=255, default='')
    ...
    price = models.BigIntegerField(validators=[MaxValueValidator(99999999999)], default=0)
    store_price = models.DecimalField(max_digits=11, decimal_places=2, default=0)
    shipping_fee = models.DecimalField(max_digits=11, decimal_places=2, default=0)
