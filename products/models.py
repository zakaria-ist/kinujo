...
class Product(models.Model):
    ...
    brand_name = models.CharField(max_length=128, default='', null=True)
    user = models.ForeignKey(Profile, on_delete=models.CASCADE, related_name='user_product', null=False)
    pr = models.TextField(default='', null=True)
    url_str = models.CharField(max_length=255, default='', null=True)
    ...
    opened_date = models.DateField(null=True, default=date.today)
    target = models.SmallIntegerField(null=True, choices=TARGET_TYPE)
    price = models.BigIntegerField(validators=[MaxValueValidator(99999999999)], default=0, null=True)
    store_price = models.DecimalField(max_digits=11, decimal_places=2, default=0, null=True)
    shipping_fee = models.DecimalField(max_digits=11, decimal_places=2, default=0, null=True)
