...
urlpatterns = [
    ...
    url(r'^client_list_json/$', views.ClientList__asJson, name='ClientList__asJson'),
    ...
    url(r'^validate_user_phone/(?P<username>.*)/$', views.validate_user_phone, name='validate_user_phone'),
