...
class Profile(models.Model):
    ...
    tel_code = models.ForeignKey(CountryCode, on_delete=models.CASCADE, null=True, related_name='primary_tel_code')
    ...
    corporate_tel_code = models.ForeignKey(CountryCode, on_delete=models.CASCADE, null=True, related_name='corporate_tel_code')
    representative_name = models.CharField(max_length=255, default='')
    message_notification_mail = models.BooleanField(default=False)
    other_notification_mail = models.BooleanField(default=False)
    message_notification_phone = models.BooleanField(default=False)
    other_notification_phone = models.BooleanField(default=False)
